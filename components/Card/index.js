    ...
    <div className={styles.card} onClick={()=>setIdPublication(slideData.id)}>
      ...
      <div className={styles.card__headline} onClick={()=>setUserId(slideData.user?.id)}>
        ...
        <div className={styles.card__headline__info}>
          <span className={styles.card__headline__info_name}>{slideData?.user?.first_name} {slideData?.user?.last_name}</span>
          {slideData?.user?.address && <span className={styles.card__headline__info_address}>{slideData?.user?.address}</span>}
        </div>
