    ...
    <div className={styles.card}>
      <div className={styles.card__headline}>
        ...
        <div className={styles.card__headline__info}>
          <span className={styles.card__headline__info_name}>{slideData?.name}</span>
          <span className={styles.card__headline__info_address}>{slideData?.address}</span>
        </div>
      ...
      <SwiperCard data={slideData?.slider}/>
